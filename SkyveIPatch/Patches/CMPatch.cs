	...
	public class CMPatch : IPatch {
        ...
        public void NoDoubleLoadPatch(AssemblyDefinition CM) {
            ...
            var mInjection = loi.MainModule.GetMethod(
                "SkyveInjections.Injections.LoadingApproach.ExistingAssembly");
        ...
        public void CreateUserModInstancePatch(AssemblyDefinition CM) {
            try {
                ...
                //var loi = GetInjectionsAssemblyDefinition(workingPath_);
                //var tLogs = loi.MainModule.GetType("SkyveInjections.Injections.Logs");
        ...
        public void EnsureIncludedExcludedPackagePatch(AssemblyDefinition CM) {
            try {
                ...
                var tCMPatchHelpers = GetInjectionsAssemblyDefinition(workingPath_).MainModule.GetType("SkyveInjections.CMPatchHelpers");
        ...
        {
            UnityEngine.Debug.Log("[SkyveIPatch] stack trace is: " + Environment.StackTrace);
        }
        ...
        /// <summary>
        /// loads SkyveInjections.dll at the beginning of PluginManger.LoadPlugins()
        /// </summary>
        public AssemblyDefinition LoadPluginsPatch(AssemblyDefinition CM)
        {
            ...
            var dllPath = Path.Combine(workingPath_, "SkyveInjections.dll");
